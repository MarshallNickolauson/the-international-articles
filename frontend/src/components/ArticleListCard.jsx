...
const ArticleListCard = ({ article }) => {
    ...
    return (
        <div
            className={`card-shadow rounded-[16px] hover:cursor-pointer transition-all duration-200 ${
                isDarkMode ? 'bg-_303030' : ''
            }`}
            ...
            <div className='flex space-x-4'>
                ...
                <div className='flex items-center w-full overflow-hidden'>
                    <div className='flex flex-col space-y-1 w-full'>
                        <h1
                            className={`text-2xl font-bold truncate transition-all duration-200 ${
                        ...
                        <h1
                            className={`text-sm italic transition-all duration-200 ${
                        ...
                        <h1
                            className={`text-lg line-clamp-1 transition-all duration-200 ${
                                isDarkMode ? 'text-white' : 'text-darkExpansion'
                            }`}
                        >
                        ...
                        <div className='flex space-x-3'>
                            <h1
                                className={`font-bold underline inline-block pb-1 transition-all duration-200 ${
                                    isDarkMode
                                        ...
                                        : 'text-darkExpansion hover:text-mainBlue'
                                } ${
                            ...
                            {location.pathname.includes('/my-articles') && (
                                <h1
                                    className={`text-xl font-bold truncate transition-all duration-200 ${
                                        isDarkMode
                                            ? 'text-white'
                                            : 'text-darkExpansion'
                                    }
