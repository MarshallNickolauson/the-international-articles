            ...
            <div className='flex space-x-4'>
                ...
                <div className='flex items-center w-full overflow-hidden'>
                    <div className='flex flex-col space-y-1 w-full'>
                        ...
                        <h1 className={`text-lg font-opensans line-clamp-1 transition-all duration-200 ${isDarkMode ? 'text-white' : 'text-darkExpansion'}`}>{cleanText}</h1>
                        <div className='flex space-x-3'>
                            {!location.pathname.includes('/my-articles') && (
                                <h1
                                    className={`font-bold font-opensans underline inline-block pb-1 transition-all duration-200 ${
                            ...
                            {location.pathname.includes('/my-articles') && (
                                <h1
                                    className={`text-lg font-bold font-opensans truncate transition-all duration-200 ${isDarkMode ? 'text-white' : 'text-darkExpansion'}
