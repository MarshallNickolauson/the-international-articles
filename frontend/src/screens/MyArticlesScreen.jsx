...
const MyArticlesScreen = () => {
    ...
    const sortedArticles =
        filteredArticles.length > 1
            ? isRotated
                ? [...filteredArticles].sort((a, b) => new Date(a.languages?.[language]?.date) - new Date(b.languages?.[language]?.date))
                : [...filteredArticles].sort((a, b) => new Date(b.languages?.[language]?.date) - new Date(a.languages?.[language]?.date))
            : filteredArticles;
